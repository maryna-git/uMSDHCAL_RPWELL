...
#define theParticleIterator ((this->subInstanceManager.offset[this->g4vpcInstanceID])._aParticleIterator)
...
void PhysListEmStandard::ConstructProcess()
{
  ...
  //
  G4VEmProcess* emOptions;
  
  //physics tables
  //
  emOptions->SetMinKinEnergy(10*eV);	//default 100 eV   
  emOptions->SetMaxKinEnergy(10*TeV);	//default 100 TeV 
